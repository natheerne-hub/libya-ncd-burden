...
LOCAL = yaml.safe_load((ROOT / "config.yaml").read_text(encoding="utf-8"))["local_context"]
...
N = {
    ...
    "sal": f"{LOCAL['avg_monthly_salary_lyd']:,}",
    "m_lo": f"{base['icer_per_daly'] * LOCAL['exchange_rate_official'] / LOCAL['avg_monthly_salary_lyd']:.0f}",
    "m_hi": f"{base['icer_per_daly'] * LOCAL['exchange_rate_parallel'] / LOCAL['avg_monthly_salary_lyd']:.0f}",
    "fx_o": f"{LOCAL['exchange_rate_official']:.2f}", "fx_p": f"{LOCAL['exchange_rate_parallel']:.2f}",
}
...
"ar": dict(
    ...
    keys=[
        ...
        f"رفع نسبة السيطرة إلى 50% يكلّف نحو <b>{N['icer']} دولاراً لكل سنة عمر صحية مكتسبة</b>، أي ما يعادل تقريباً <b>{N['m_lo']} إلى {N['m_hi']} أشهر من متوسط مرتب موظف حكومي</b>، وهو أقل بكثير من نصيب الفرد من الناتج المحلي ({N['gdp']} دولاراً).",
    ],
    ...
    s6="عن هذا التحليل",
    p6=f"البيانات: المرصد الصحي العالمي لمنظمة الصحة العالمية (2000–2024)، ودراسة العبء العالمي للمرض 2023 (IHME، 2024)، والتوقعات السكانية للأمم المتحدة 2024، مع المقارنة بتونس والجزائر ومصر والمغرب. يعتمد النموذج الاقتصادي على تكاليف منشورة (حزمة HEARTS، ودراسات مستشفيات مغربية) وعلى أثر علاجي منشور (Ettehad وزملاؤه، Lancet 2016)، مع تحليل حساسية احتمالي بخمسة آلاف محاكاة. تحويل التكلفة إلى أشهر مرتب مبني على متوسط تقديري قدره {N['sal']} دينار شهرياً (باب المرتبات ÷ عدد الموظفين، مصرف ليبيا المركزي 2023–2025) وسعر صرف {N['fx_o']} رسمي و{N['fx_p']} موازٍ (سبتمبر 2026). التقديرات نمذجة تنطوي على قدر كبير من عدم اليقين، ولا يزال أحد المدخلات (تكاليف إدارة البرنامج) افتراضياً. الكود والبيانات والمنهجية: github.com/natheerne-hub/libya-ncd-burden",
